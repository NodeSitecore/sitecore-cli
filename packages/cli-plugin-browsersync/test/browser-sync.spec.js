// const browserSyncSpec = require('browser-sync');
// const config = require('@node-sitecore/config');
// const path = require('path');
// const execa = require('execa');
// const { Sinon } = require('../../test/tools');
// const formatPath = require('../../cli/src/utils/format-path');
// const proxyServer = require('../src/browser-sync');
//
// xdescribe('proxyServer', () => {
//   const staticPath = formatPath(path.join(config.rootDir, config.get('websiteRoot')));
//
//   before(() => {
...
//     };
//
//     this.browserSyncCreateStub = Sinon.stub(browserSyncSpec, 'create').returns(this.browserSyncStub);
...
//     this.browserSyncStub.init.should.have.been.calledWithExactly(
//       Sinon.match({
//         open: false,
