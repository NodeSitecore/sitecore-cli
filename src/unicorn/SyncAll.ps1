...
# Sync-Unicorn -ControlPanelUrl $url -SharedSecret $secret -Configurations @('Test1', 'Test2')

# SYNC ALL CONFIGURATIONS, SKIPPING ANY WITH TRANSPARENT SYNC ON
# Sync-Unicorn -ControlPanelUrl $url -SharedSecret $secret -SkipTransparentConfigs
